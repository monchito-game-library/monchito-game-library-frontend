...
describe('GameSaleFormComponent', () => {
  ...
  describe('onSave', () => {
    ...
    it('establece salePrice a null cuando forSale es true pero salePrice es null', async () => {
      const gameUseCases = TestBed.inject(GAME_USE_CASES as any) as any;
  ...
  describe('_userId — guard (userId null)', () => {
    let guardHostFixture: ComponentFixture<TestHostComponent>;
    let guardComponent: GameSaleFormComponent;
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        ...
        providers: [
          {
            provide: GAME_USE_CASES,
            useValue: { updateSaleStatus: vi.fn().mockResolvedValue(undefined) } as Partial<GameUseCasesContract>
          },
          { provide: MatSnackBar, useValue: { open: vi.fn() } },
      ...
      guardHostFixture = TestBed.createComponent(TestHostComponent);
      guardHostFixture.detectChanges();
      guardComponent = guardHostFixture.debugElement.query(By.directive(GameSaleFormComponent))
        .componentInstance as GameSaleFormComponent;
    });
