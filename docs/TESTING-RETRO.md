...
| ---------- | ------------------- | --------- | ---- |
| Statements | 64.98% (952 / 1465) | 60% ✅    | 90%  |
| Branches   | 68.45% (688 / 1005) | —         | —    |
| Functions  | 58.67% (186 / 317)  | —         | —    |
| Lines      | 62.93% (759 / 1206) | 60% ✅    | 90%  |
...
| `retro-datepicker/retro-datepicker.component.spec.ts`                                 | 10    |
| `retro-dialog/services/retro-dialog-integration.spec.ts`                              | 6     |
| `retro-dialog/services/retro-dialog.service.spec.ts`                                  | 8     |
...
| `retro-form-field/components/retro-input/retro-input.directive.spec.ts`               | 3     |
...
| `retro-input/retro-input.component.spec.ts`                                           | 9     |
...
| `retro-menu/components/retro-menu-item/retro-menu-item.component.spec.ts`             | 5     |
| `retro-menu/directive/retro-menu-trigger.directive.spec.ts`                           | 4     |
| `retro-overlay/services/retro-overlay.service.spec.ts`                                | 8     |
| `retro-search/retro-search.component.spec.ts`                                         | 9     |
| `retro-section-header/retro-section-header.component.spec.ts`                         | 4     |
| `retro-select/retro-select.component.spec.ts`                                         | 9     |
...
| `retro-snackbar/components/retro-snackbar-host/retro-snackbar-host.component.spec.ts` | 1     |
| `retro-spinner/retro-spinner.component.spec.ts`                                       | 2     |
| `retro-tabs/retro-tabs.component.spec.ts`                                             | 8     |
