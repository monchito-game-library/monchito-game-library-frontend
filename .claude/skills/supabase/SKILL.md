---
name: supabase
description: 'Use for any Supabase task: database schema and migrations, Auth/RLS/JWT sessions, Edge Functions, Realtime, Storage, supabase-js client code, and the Supabase CLI or MCP server.'
metadata:
  author: supabase
  version: '0.1.2'
---
