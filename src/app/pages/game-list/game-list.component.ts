...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MatFormField, MatLabel, MatInput, MatSelect, MatOption, MatCard, MatCardHeader, MatIconButton, RouterLink, MatIcon, MatCardContent, MatCardSubtitle, MatCardTitle],
