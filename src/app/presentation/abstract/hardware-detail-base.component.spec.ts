...
class TestHardwareDetailComponent extends HardwareDetailBaseComponent {
  ...
  itemId: string | undefined = 'item-123';
  deleteError = false;
  ...
  // eslint-disable-next-line jsdoc/require-jsdoc
  onSaveCompleted(_values: SaleAvailabilityValues): void {}

  // eslint-disable-next-line jsdoc/require-jsdoc
  onLoanSaved(_updated: HardwareLoanItem): void {}
