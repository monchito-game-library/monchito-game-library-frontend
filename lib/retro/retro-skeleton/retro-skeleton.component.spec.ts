...
describe('RetroSkeletonComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({ imports: [RetroSkeletonComponent] });
  ...
  it('aplica width y height al elemento via ngStyle', () => {
    ...
    fixture.detectChanges();
    const el: HTMLElement = fixture.nativeElement.querySelector('.retro-skeleton');
  ...
  it('aplica la clase de shape correcta', () => {
    ...
    fixture.detectChanges();
    const el: HTMLElement = fixture.nativeElement.querySelector('.retro-skeleton');
    expect(el.classList.contains('retro-skeleton--square')).toBe(true);
  });
});
