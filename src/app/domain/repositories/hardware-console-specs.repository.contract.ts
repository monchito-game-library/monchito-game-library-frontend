...
export interface HardwareConsoleSpecsRepositoryContract {
  /**
...
export const HARDWARE_CONSOLE_SPECS_REPOSITORY = new InjectionToken<HardwareConsoleSpecsRepositoryContract>(
