...
describe('GameCoverPositionDialogComponent', () => {
  ...
  describe('con initialPosition con escala por encima del máximo', () => {
    beforeEach(() => setup('50 50 10.00'));

    it('clampea scale al máximo (4)', () => expect(component.scale()).toBe(4));
  });

  describe('con initialPosition con escala por debajo del mínimo', () => {
    beforeEach(() => setup('50 50 0.50'));

    it('clampea scale al mínimo (1)', () => expect(component.scale()).toBe(1));
  });
});
