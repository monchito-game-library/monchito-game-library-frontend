...
export interface HardwareEditionRepositoryContract {
  /**
  ...
  /**
   * Creates a new hardware edition under a given model.
   *
...
export const HARDWARE_EDITION_REPOSITORY = new InjectionToken<HardwareEditionRepositoryContract>(
