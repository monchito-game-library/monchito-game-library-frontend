...
describe('ControllersComponent', () => {
  ...
  describe('onDetail()', () => {
    it('navega a /games/controllers/:id', () => {
      const ctrl = makeController({ id: 'controller-abc' });

      component.onDetail(ctrl);

      expect(mockRouter.navigate).toHaveBeenCalledWith(['/games/controllers', 'controller-abc']);
    });
  });

  describe('onAdd()', () => {
    it('navega a /games/controllers/add', () => {
      component.onAdd();

      expect(mockRouter.navigate).toHaveBeenCalledWith(['/games/controllers/add']);
    });
  });
});
