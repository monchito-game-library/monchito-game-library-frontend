...
import { RetroOverlayService, RetroOverlayRef } from '@/services/retro-overlay/retro-overlay.service';
...
describe('RETRO_DIALOG_DATA', () => {
  it('es el mismo token que RETRO_OVERLAY_DATA', () => {
    const { RETRO_OVERLAY_DATA } = require('@/services/retro-overlay/retro-overlay.service');
