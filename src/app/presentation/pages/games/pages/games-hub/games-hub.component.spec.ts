...
describe('GamesHubComponent', () => {
  ...
  describe('goToGames()', () => {
    it('navega a /games/list', () => {
      component.goToGames();
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/games/list']);
    });
  });
  ...
  describe('goToConsoles()', () => {
    it('navega a /games/consoles', () => {
      ...
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/games/consoles']);
    });
  });
  ...
  describe('goToControllers()', () => {
    it('navega a /games/controllers', () => {
      ...
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/games/controllers']);
    });
  });
