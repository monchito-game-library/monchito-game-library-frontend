...
| `improve-coverage`     | `[retro\|app]`                 | Genera el informe lcov del ámbito elegido, identifica gaps reales (descartando artefactos V8/signals documentados), escribe los tests mínimos necesarios y actualiza el `TESTING.md` correspondiente                              |
