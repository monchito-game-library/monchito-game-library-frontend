...
describe('ControllerDetailComponent', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('navega a /games/controllers si el mando no existe (null)', async () => {
      const controllerUseCases = TestBed.inject(CONTROLLER_USE_CASES as any) as any;
      ...
      expect(router.navigate).toHaveBeenCalledWith(['/games/controllers']);
    });

    it('navega a /games/controllers si la carga falla', async () => {
      const controllerUseCases = TestBed.inject(CONTROLLER_USE_CASES as any) as any;
  ...
  describe('onEdit', () => {
    it('navega a /games/controllers/edit/:id cuando el mando está cargado', () => {
      component.controller.set(makeController());
      const router = TestBed.inject(Router as any) as any;

      component.onEdit();

      expect(router.navigate).toHaveBeenCalledWith(['/games/controllers/edit', 'controller-uuid-1']);
    });
  ...
  describe('onSaleSaved', () => {
    it('navega a /games/controllers cuando el mando queda vendido (soldAt presente)', () => {
      const router = TestBed.inject(Router as any) as any;
  ...
  describe('onDelete', () => {
    ...
    it('llama a delete y navega a /games/controllers si se confirma', async () => {
      component.controller.set(makeController());
      const controllerUseCases = TestBed.inject(CONTROLLER_USE_CASES as any) as any;
      const dialog = TestBed.inject(MatDialog as any) as any;
