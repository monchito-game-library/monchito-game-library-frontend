...
import { RetroSnackbarService } from './retro-snackbar.service';

describe('RetroSnackbarService', () => {
  let service: RetroSnackbarService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(RetroSnackbarService);
  });
